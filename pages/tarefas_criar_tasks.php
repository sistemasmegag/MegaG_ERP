...
<head>
  ...
  html[data-theme="dark"] .btnx{ background: rgba(255,255,255,.06); }
  .btnx:hover{ border-color: rgba(13,110,253,.35); }
  .btnx.primary{
    background: rgba(13,110,253,.12);
    border-color: rgba(13,110,253,.25);
    color: #0b5ed7;
  }
  html[data-theme="dark"] .btnx.primary{ color: rgba(255,255,255,.92); }

  .card-body{ padding: 16px; }
  .row{ display:flex; gap:12px; flex-wrap:wrap; }
  .field{ flex:1; min-width: 240px; }
  label{ display:block; font-size: 11px; font-weight: 900; letter-spacing:.08em; color: var(--saas-muted); text-transform: uppercase; margin-bottom: 6px; }
  ...
  html[data-theme="dark"] .hr{ background: rgba(255,255,255,.10); }

  .msg{ margin-top:10px; font-weight: 900; font-size: 13px; display:none; }
  .msg.ok{ color: #16a34a; display:block; }
  .msg.err{ color: #dc2626; display:block; }

  .hint{ color: var(--saas-muted); font-size: 12px; margin-top: 8px; }
  </style>
</head>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="field">
            ...
            <input id="fResponsavel" placeholder="Ex: Felipe" />
          </div>
          <div class="field">
