<?php
$paginaAtual = 'imp_metas_gap';
?>

<style>
/* ===== Clean SaaS (escopado pra página IMP_METAS_GAP) ===== */
.saas-head{
      ...
      <div class="col-lg-10 col-xl-9">
        ...
        <div class="saas-head mb-4">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 position-relative">
            <div>
              <h3 class="saas-title">Importação Metas GAP - Setor de Vendas</h3>
              <p class="saas-subtitle">
                Faça o upload da planilha com
                <strong>CODPERIODO, CODMETA, GAP</strong>.
              </p>
            </div>
        ...
        <div class="card saas-card mb-4">
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                <div class="fw-bold text-dark" style="letter-spacing:-.01em;">Metas GAP - Setor de Vendas</div>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <small class="text-muted">
              Colunas esperadas: CODPERIODO | CODMETA | GAP.
            </small>
          </div>
        </div>
...
async function iniciar() {
  ...
  try {
    ...
    const evt = new EventSource(`processors/processa_imp_metas_gap.php?arquivo=${encodeURIComponent(json.arquivo)}`);
