...
<style>
/* ===== Clean SaaS (escopado pra página IMP_BI_METAS) ===== */
.saas-head{
        ...
        <div class="saas-head mb-4">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 position-relative">
            ...
            <div class="d-flex align-items-center gap-2">
              <span class="badge rounded-pill bg-warning bg-opacity-10 text-white fw-bold px-3 py-2">
                Destino: Oracle
              </span>
            </div>
          </div>
          ...
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                <div class="fw-bold text-dark" style="letter-spacing:-.01em;">Metas Setor de Compras</div>
              </div>
            </div>
...
async function iniciar() {
  ...
  try {
    ...
    const evt = new EventSource(`processors/processa_imp_bi_metas.php?arquivo=${encodeURIComponent(json.arquivo)}`);
