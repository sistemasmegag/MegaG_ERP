<?php 
// Se estiver numa subpasta, mantenha ../. Se estiver na raiz, mude para ./
$paginaAtual = 'imp_setormetacapac'; 
?>

<style>
/* ===== Clean SaaS (escopado pra página Cargas) ===== */
.saas-head{
...
/* Cards SaaS (reutiliza tokens do header) */
.saas-card{
            ...
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="saas-head mb-4">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 position-relative">
                        <div>
                            <h3 class="saas-title">Importação de Cargas/Metas</h3>
                            <p class="saas-subtitle">
                                Faça o upload da planilha com <strong>Setor, Turno, Metas e Capacidade</strong> e acompanhe o processamento em tempo real.
                            </p>
                        </div>
                ...
                <div class="card saas-card mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <div class="fw-bold text-dark" style="letter-spacing:-.01em;">Importação de Cargas/Metas</div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-4">
                            Selecione o arquivo (<strong>.xls</strong> ou <strong>.xlsx</strong>) e clique em importar. O log abaixo exibirá cada etapa.
                        </p>

                        <div class="input-group input-group-lg mb-2 saas-upload">
                            <input type="file" class="form-control" id="arquivoInput" accept=".xls,.xlsx">
                            <button class="btn btn-primary px-4" type="button" onclick="iniciar()" id="btnGo">
                                <i class="bi bi-play-fill me-1"></i> IMPORTAR CARGAS
                            </button>
                        </div>

                        <small class="text-muted">Destino: Tabela de Operações (Oracle).</small>
                    </div>
                </div>
...
<script>
    ...
    async function iniciar() {
        ...
        try {
            ...
            const evt = new EventSource(`processors/processa_universal_insert.php?tipo=setormetacapac&arquivo=${json.arquivo}`);
