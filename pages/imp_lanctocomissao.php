<?php
$paginaAtual = 'imp_lanctocomissao';
?>

<style>
/* ===== Clean SaaS (escopado pra página IMP_LANCTOCOMISSAO) ===== */
.saas-head{
...
.saas-head:before{
    ...
    width: 360px;
    height: 360px;
    background: radial-gradient(circle at 30% 30%, rgba(13,110,253,.45), transparent 60%);
    filter: blur(6px);
      ...
      <div class="col-lg-10 col-xl-9">
        ...
        <div class="saas-head mb-4">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 position-relative">
            <div>
              <h3 class="saas-title">Importação Comissão de Transportadores</h3>
              <p class="saas-subtitle">
                Faça o upload da planilha com <strong>CODEVENTO, SEQPESSOA, DTAHREMISSAO, OBSERVAÇÃO, VLRTOTAL</strong>.
              </p>
            </div>
        ...
        <div class="card saas-card mb-4">
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                <div class="fw-bold text-dark" style="letter-spacing:-.01em;">Comissão de Transportadores</div>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <small class="text-muted">
              Colunas esperadas: CODEVENTO | SEQPESSOA | DTAHREMISSAO | OBSERVAÇÃO | VLRTOTAL.
            </small>
          </div>
        </div>
...
async function iniciar() {
  ...
  try {
    ...
    const evt = new EventSource(`processors/processa_lanctocomissao.php?arquivo=${encodeURIComponent(json.arquivo)}`);
