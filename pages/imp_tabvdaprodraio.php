<?php
$paginaAtual = 'imp_tabvdaprodraio';
?>

<style>
/* ===== Clean SaaS (escopado pra página IMP_TABVDAPRODRAIO) ===== */
.saas-head{
...
.saas-head:before{
    ...
    width: 360px;
    height: 360px;
    background: radial-gradient(circle at 30% 30%, rgba(25,135,84,.28), transparent 60%);
    filter: blur(6px);
      ...
      <div class="col-lg-10 col-xl-9">
        ...
        <div class="saas-head mb-4">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 position-relative">
            <div>
              <h3 class="saas-title">Importação Custo de Comercialização</h3>
              <p class="saas-subtitle">
                Faça o upload da planilha com <strong>NROTABVENDA, SEQPRODUTO, RAIO, PERAD</strong>.
              </p>
            </div>
        ...
        <div class="card saas-card mb-4">
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                <div class="fw-bold text-dark" style="letter-spacing:-.01em;">Custo de Comercialização</div>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <small class="text-muted">Colunas esperadas: NROTABVENDA | SEQPRODUTO | RAIO | PERAD.</small>
          </div>
        </div>
